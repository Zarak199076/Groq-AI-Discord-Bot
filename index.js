...
// Generates an image, preferring Hugging Face's FLUX.1-dev routed through
// provider "auto" — this lets HF pick a stronger third-party backend (fal,
// Together, etc.) for the same model instead of always using HF's own basic
// free-tier backend, which is the likely source of inconsistent quality.
// Falls back to Pollinations if the HF call fails for any reason.
